...
public class FriskyShimmer {
    ...
    public FriskyShimmer setRepeatCount(int repeatCount) {
    ...
    public FriskyShimmer setDuration(long duration) {
    ...
    public FriskyShimmer setStartDelay(long startDelay) {
    ...
    public FriskyShimmer setDirection(int direction) {
    ...
    public <V extends View & FriskyShimmerViewBase> void start(final V shimmerView) {
        ...
        if (!shimmerView.isSetUp()) {
            shimmerView.setAnimationSetupCallback(new FriskyShimmerViewHelper.AnimationSetupCallback() {
                @Override
