...
public class FriskyFriskyShimmerButton extends Button implements FriskyShimmerViewBase {

    private FriskyShimmerViewHelper friskyShimmerViewHelper;

    public FriskyFriskyShimmerButton(Context context) {
        super(context);
    ...
    public FriskyFriskyShimmerButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        friskyShimmerViewHelper = new FriskyShimmerViewHelper(this, getPaint(), attrs);
        friskyShimmerViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public FriskyFriskyShimmerButton(Context context, AttributeSet attrs, int defStyle) {
